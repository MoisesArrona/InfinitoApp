    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/novedad/{{$novedad->id}}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf

                        <div class="form-group col-md-6">
                            <label for="">Titulo</label>
                            <input class="form-control " type="text" value="{{$novedad->titulo}}" name="titulo">
                            @error('titulo')
                                <code>{{$message}}</code>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{$novedad->cuerpo}}" name="cuerpo">
                            @error('cuerpo')
                                <code>{{$message}}</code>
                            @enderror
                        </div>
